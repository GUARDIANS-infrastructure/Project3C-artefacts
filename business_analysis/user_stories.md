...
| US18 | Security  |  Trist and Identity | Data Controller  |  to be assured that users accessing QIMRB's systems user login credentials verified by their affiliated institution | we adhere to data sharing guidelines and laws, and we only allow access to authenticated and authorised people. |  High - Essential |
| US19 |   |   |   |   |   |   |
| US20 |   |   |   |   |   |   |
| US21 |   |   |   |   |   |   |
| US22 |   |   |   |   |   |   |
