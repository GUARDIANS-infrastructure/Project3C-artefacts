...
| [US2](use_case_diagrams/QIMRB%20Publication%20Tracking%20and%20Data%20Access%20Reporting%20User%20Story%202%20Use%20Case%20Diagram.pdf) | Functional | Publication Tracking and Data Access Reporting | Data Controller | to be appropriately acknowledged for the supply of data and be informed as to its use | we can report to our funders and demonstrate additional impact from the data. | High - Essential |   |
...
| [US8](use_case_diagrams/QIMRB%20DUO%20Codes%20User%20Story%208%20DUO%20Codes%20Use%20Case%20Diagram.pdf) | Functional | Consent, Ethics and Data Use Ontology | Researcher | to use DUO codes to check what uses of data are consented for. | when I select and apply for data, I am confident that ethically, I can use it for the type of use that I have planned. | High - Essential |   |
...
| [US16](use_case_diagrams/QIMRB%20Metadata%20Quality%20User%20Story%2016%20Use%20Case%20Diagram.pdf) | Functional | Data Quality and Metadata | Researcher | to see a minimum standard of data quality information in the metadata: e.g. read depths, or number of reads sequenced, library type as a minimum quality control description | I don't have to apply for and then download something before discovering its quality is not acceptable. | High - Essential |   |
...
|[US18](use_case_diagrams/QIMRB%20Trust%20and%20Identity%20User%20Story%2018%20Use%20Case%20Diagram.pdf) | Security  |  Trust and Identity | Data Controller  |  to be assured that users accessing QIMRB's GUARDIANS infrastructure have login credentials verified by their affiliated institution | we adhere to data sharing guidelines and laws, and we only allow access to authenticated and authorised people. |  High - Essential |
| US19 |   |   |   |   |   |   |
| US20 |   |   |   |   |   |   |
| US21 |   |   |   |   |   |   |
| US22 |   |   |   |   |   |   |
